...
def generate_variant_1_1(config: BusinessConfig) -> str:
    ...
    return f"""
        ...
        Your answer should ONLY contain two numbers, separated by a comma, nothing else.
        The first number being what you would be willing to pay, and the second one being what you wish to
